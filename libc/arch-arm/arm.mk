...
$(error "TARGET_$(my_2nd_arch_prefix)CPU_VARIANT not set or set to an unknown value. Possible values are cortex-a5, cortex-a7, cortex-a8, cortex-a9, cortex-a15, krait, denver, scorpion, tegra2. Use generic for devices that do not have a CPU similar to any of the supported cpu variants.")
endif
